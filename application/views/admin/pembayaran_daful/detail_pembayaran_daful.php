   ...
   <div class="x_panel post-inherit">
      ...
      <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="number" name="max_cicilan" value="<?=$row_data->row()->max_angsuran?>" class="form-control" required />
            </div>
             <small>
             <i>*) Wajib diisi</i>
             </small>
         ...
         <table class="table table-stripped">
             ...
             <tbody>
                ...
                <tr>
                    ...
                    <td><a href="#" class="btn btn-xs btn-danger">Transaksi</a></td>
                </tr>
                 <?php }?>
             </tbody>
         </table>
             ...
             <tbody>
                <?php foreach($list_detail_daful->result() as $row_detail_daful){?>
                 <tr>
                   ...
                   <td>Rp. <?=number_format($row_detail_daful->nominal_bayar)?></td>
                 </tr>
                 <?php }?>
             </tbody>
         </table>
