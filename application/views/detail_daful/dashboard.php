<div class="col-md-12 col-sm-12 col-xs-12 main post-inherit">
    <div class="x_panel post-inherit">
        <h3 class="">
            ...
            <a href="<?php echo base_url('detail_daful/tambah_detail_daful'); ?>" ><span class="glyphicon glyphicon-plus-sign"></span></a>
        </h3>
        <br>
<!--
                    ...
                    foreach ($list_detail_daful as $row) {
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success btn-xs" href="<?php echo base_url('pembayaran/detail/' . $row->id_detail_daftar_ulang); ?>" ><i class="fa fa-eye" aria-hidden="true"></i></a>
